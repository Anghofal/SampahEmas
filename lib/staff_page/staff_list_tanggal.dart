...
class ListDateStaffPage extends StatelessWidget {
  const ListDateStaffPage({super.key});

  @override
  Widget build(BuildContext context) {
    return ListDateStaffPageFull();
  }
}

class ListDateStaffPageFull extends StatefulWidget {
  const ListDateStaffPageFull({super.key});

  @override
  State<StatefulWidget> createState() => _ListDateStaffPageFull();
}

class _ListDateStaffPageFull extends State<ListDateStaffPageFull> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Tanggal Pilah Sampah', style: TextStyle(color: yellowColor)),
        centerTitle: true,
            ...
            return GestureDetector(
              onTap: () {
                Navigator.pushNamedAndRemoveUntil(
                  context, 
                  '/list_rt_pilah', // Nama route tujuan
                  ModalRoute.withName('/list_tanggal_pilah'), 
