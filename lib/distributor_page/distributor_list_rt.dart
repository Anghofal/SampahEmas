...
class ListRtPage extends StatelessWidget {
  const ListRtPage({super.key});

  @override
  Widget build(BuildContext context) {
    return ListRtPageFull();
  }
}

class ListRtPageFull extends StatefulWidget {
  const ListRtPageFull({super.key});

  @override
  State<StatefulWidget> createState() => _ListRtPageFull();
}

class _ListRtPageFull extends State<ListRtPageFull> {
              ...
              return GestureDetector(
                onTap: () {
                  ...
                  Navigator.pushNamedAndRemoveUntil(
                    context, 
                    '/list_alamat_ambil', // Nama route tujuan
                    ModalRoute.withName('/list_rt_ambil'),
                    arguments: {
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          daerahKerjaGlobal = daerahKerja;
                          showDialog(
                            context: context,
                            builder: (BuildContext context) {
                              return AlertDialog(
                                title: Text('Konfirmasi'),
                                content: Text('Apakah sampah milik $daerahKerja sudah sampai ke pemilah?'),
                                actions: <Widget>[
                                  TextButton(
                                    onPressed: () {
                                      // Lakukan aksi jika user memilih "Tidak"
                                  ...
                                  TextButton(
                                    onPressed: () {
                                      // Lakukan aksi jika user memilih "Ya"
                                      updateLaporanFromFirestore();
                                      print('Sampah dari RT $daerahKerja sudah sampai ke pemilah');
                                      Navigator.of(context).pop(); // Tutup dialog
                                    },
                                    child: Text('Ya'),
                                  ),
